...
function docReady() {
    ...
    $('.btn-close').click(function (e) {
        e.preventDefault();
        var neoModal = $(this).attr("data-neo-modal");
        if (neoModal != "true") {
...
window.alert = function (text, userOrignal) {
    if (userOrignal === true) {
        window.original_alert(text);
        return;
    }
    notyOpt.text = text;
    noty(notyOpt);
}
window.alertError = function (text, userOrignal) {
    if (userOrignal === true) {
        window.original_alert(text);
        return;
    }
    notyOptError.text = text;
    noty(notyOptError);
}