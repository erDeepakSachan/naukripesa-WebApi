...
import { EditComponent } from './webpage.component.edit';
import { AddComponent } from './webpage.component.add';
...
export class WebpageComponent implements OnInit {
  data: Webpage[] = [];
  selectedData: Webpage | null = null;
  ...
  constructor(public svc: WebpageService) {
  }
