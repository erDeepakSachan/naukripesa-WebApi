...
import { EditComponent } from './usergroup.component.edit';
import { AddComponent } from './usergroup.component.add';
...
export class UserGroupComponent implements OnInit {
  data: UserGroup[] = [];
  selectedData: UserGroup | null = null;
  ...
  constructor(public svc: UserGroupService) {
  }
