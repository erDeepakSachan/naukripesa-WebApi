...
import { EditComponent } from './usergrouppermission.component.edit';
import { AddComponent } from './usergrouppermission.component.add';
...
@Component({
  ...
  selector: 'app-usergrouppermission',
  templateUrl: './usergrouppermission.component.html',
  styleUrls: ['./usergrouppermission.component.css']
})
export class UserGroupPermissionComponent implements OnInit {
  data: UserGroupPermission[] = [];
  selectedData: UserGroupPermission | null = null;
  ...
  constructor(public svc: UserGroupPermissionService) {
  }
  ...
  edit(obj: UserGroupPermission): void {
