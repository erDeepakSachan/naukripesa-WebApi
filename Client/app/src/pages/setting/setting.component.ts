...
import { EditComponent } from './setting.component.edit';
import { AddComponent } from './setting.component.add';
...
export class SettingComponent implements OnInit {
  data: Setting[] = [];
  selectedData: Setting | null = null;
  ...
  constructor(public svc: SettingService) {
  }
